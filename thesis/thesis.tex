...
\begin{subfigure}{\linewidth}
    ...
    \caption{
        ...
        The table below shows the relative amount of code and data misses with \emph{Upstream OSv (halt)} as a baseline.
        The influence of instruction working set spreading is visible in a 65\% reduction of L2 code misses with our solution.
    }
...
\end{subfigure}
\par\bigskip
\caption{Validation of instruction working set spreading through CPU performance counters.}
\end{figure}
