...
To smoothen out spikes spikes due to frequent switching of threads between blocked and runnable state, we then feed this vector through exponentially-decaying moving average filte .
