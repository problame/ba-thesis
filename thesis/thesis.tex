...
\end{itemize}%
The suggestions above revert the complex situation of \ults and \klts to a simple 1:1 threading model, removing the special-case of blocking kernel activity.
...
The benchmark does not perform any work in a stage and switches immediately to the next one, thus reaching the first stage again before both of its cores went to sleep.
