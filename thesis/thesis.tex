    ...
    \begin{itemize}
        ...
        \item \textbf{Upstream OSv}
            ...
            \begin{itemize}
                ...
                \item The additional implementation of the stage API on top of the upstream primitives is \gitcommit{bf6ed9ac51aa30bcf989796fb4597979f66b6581} which is HEAD of the \gitbranch{eval\_upstream\_threadmig}
            \end{itemize}
    \end{itemize}
